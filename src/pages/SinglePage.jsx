...
function SinglePage() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${param.movieId}?api_key=3bf3a3b00cb251027bb7566559b066c1&language=en-US`
      )
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${param.movieId}/videos?api_key=3bf3a3b00cb251027bb7566559b066c1&language=en-US`
      )
      .then((res) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.themoviedb.org/3/movie/${param.movieId}/similar?api_key=3bf3a3b00cb251027bb7566559b066c1&language=en-US&page=1`
      )
      .then((res) => {
        // console.log(res?.data?.results);
        // console.log(res?.data?.results);
        ...
        {suggest?.map((e) => {
          return (
            <MoviesList key={e.id}>
              ...
              <NameMovie to={"/movie/" + e.id} >
                <NameFilm>{e.title}</NameFilm>
              </NameMovie>
            </MoviesList>
          );
        })}
