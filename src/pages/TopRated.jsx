...
const Container = styled.div`
  ...
  background-image: linear-gradient(180deg, #132a37cc, #132a37cc),
    url("https://images.unsplash.com/photo-1562398766-0f40f880a33a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=470&q=80");
  ...
  useEffect(() => {
    axios
      .get(
        ...
        `https://api.themoviedb.org/3/movie/top_rated?api_key=3bf3a3b00cb251027bb7566559b066c1&language=en-US&page=${page}`      )
      .then((res) => {
